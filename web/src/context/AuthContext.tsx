...
export const AuthProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    ...
    const hasPermission = (permission: AcademicPermission) => {
        ...
        const roleDefaultPermissions: Record<string, string[]> = {
            ...
            'DIRECTEUR': ['DASHBOARD_ETABLISSEMENT', 'WEB_VERSION', 'ACADEMIC_STATS', 'VIEW_STUDENT_LIST', 'STUDENT_DOSSIER', 'MANAGE_ACADEMIC_CONFIG', 'VALIDATE_GRADES', 'GRADES_REPORT_SHEET', 'GLOBAL_ATTENDANCE', 'MANAGE_ABSENCES', 'SUMMARY'],
            'DIRECTEUR_DES_ETUDES': ['DASHBOARD_ETABLISSEMENT', 'WEB_VERSION', 'MANAGE_ACADEMIC_CONFIG', 'MANAGE_GRADES', 'VALIDATE_GRADES', 'GRADES_REPORT_SHEET', 'VIEW_STUDENT_LIST', 'ACADEMIC_STATS', 'MANAGE_ABSENCES'],
            ...
            'SURVEILLANT_GENERAL': ['DASHBOARD_ETABLISSEMENT', 'WEB_VERSION', 'VIEW_STUDENT_LIST', 'STUDENT_DOSSIER', 'GLOBAL_ATTENDANCE', 'MANAGE_ABSENCES', 'MANAGE_JUSTIFICATIONS', 'MANAGE_SANCTIONS', 'EXIT_SLIP'],
            'ENSEIGNANT': ['DASHBOARD_ETABLISSEMENT', 'WEB_VERSION', 'MANAGE_GRADES', 'EDIT_STUDENT_NOTE', 'GRADES_REPORT_SHEET', 'MANAGE_ABSENCES', 'SUMMARY'],
